...
export default function AboutCard() {
  return (
    <CardLayout>
      <Card>
        <Intro
          primary="About Phasmophobia Helper"
          secondary="Get to know the website a bit better!"
        />
        <Writing>
          <p>
            Welcome to the Phasmophobia Helper website! My main mission is to make identifying ghost
            types in the thrilling video game{' '}
        ...
        <Divider />
        <Intro primary="Perks" secondary="Why choose this over the in-game journal?" />
        <Writing>
          <p>
          ...
          <ul>
            ...
            <li>
              Impossible evidence is marked with a lock icon (e.g., Ghost Writing is impossible when
              you&apos;ve checked DOTS and EMF, as no ghost types have that combination)
            </li>
            <li>
              Quick sanity threshold info for each ghost type to help gauge when a ghost might start
              hunting
            </li>
            <li>
        ...
        <Divider />
        <Intro primary="Report a mistake" secondary="Spotted something off? Let me know!" />
        <Writing>
          <p>
